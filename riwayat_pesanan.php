...
<head>
    ...
    * {
    ...
    body {
        ...
        min-height: 100vh;
        min-width: 1200px; /* Set minimum width agar tidak terlalu sempit saat zoom out */
        overflow-x: auto;
    }
    ...
    .table th,
    .table td {
        min-width: 60px; /* Set minimum width untuk setiap kolom */
        max-width: 200px; /* Set maximum width untuk mencegah kolom terlalu lebar */
        overflow: hidden;
    ...
    .table th:nth-child(1), .table td:nth-child(1) { width: 6%; min-width: 50px; } /* No */
    .table th:nth-child(2), .table td:nth-child(2) { width: 10%; min-width: 80px; } /* ID Transaksi */
    .table th:nth-child(3), .table td:nth-child(3) { width: 15%; min-width: 100px; } /* Nama Penyewa */
    .table th:nth-child(4), .table td:nth-child(4) { width: 12%; min-width: 90px; } /* No. Telp */
    .table th:nth-child(5), .table td:nth-child(5) { width: 15%; min-width: 100px; } /* Foto Kostum */
    .table th:nth-child(6), .table td:nth-child(6) { width: 13%; min-width: 90px; } /* Detail Kostum */
    .table th:nth-child(7), .table td:nth-child(7) { width: 6%; min-width: 50px; } /* Size */
    .table th:nth-child(8), .table td:nth-child(8) { width: 5%; min-width: 40px; } /* Qty */
    .table th:nth-child(9), .table td:nth-child(9) { width: 10%; min-width: 80px; } /* Subtotal */
    .table th:nth-child(10), .table td:nth-child(10) { width: 10%; min-width: 80px; } /* Tgl Pinjam */
    .table th:nth-child(11), .table td:nth-child(11) { width: 6%; min-width: 50px; } /* Jml Hari */
    .table th:nth-child(12), .table td:nth-child(12) { width: 12%; min-width: 90px; } /* Tgl Mulai */
    .table th:nth-child(13), .table td:nth-child(13) { width: 12%; min-width: 90px; } /* Tgl Selesai */
    .table th:nth-child(14), .table td:nth-child(14) { width: 12%; min-width: 90px; } /* Status */
    .table th:nth-child(15), .table td:nth-child(15) { width: 10%; min-width: 80px; } /* Bukti Pencairan */
    ...
    /* Media query untuk mobile devices (opsional) */
    @media (max-width: 768px) {
        body {
            min-width: unset;
            overflow-x: auto;
...
<body>
    ...
    <div class="container">
        <aside class="sidebar" style="margin-bottom: 500px;">
            <ul>
