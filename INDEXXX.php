...
<head>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">
   ...
   .sidebar {
        ...
        width: 220px;
        min-width: 180px; /* Tambahkan min-width */
        padding: 1rem 1rem;
    ...
    .sidebar li.active a {
        ...
        .main-content {
            flex: 1;
            padding: 1rem 2rem;
            width: calc(100% - 220px); /* Sesuaikan dengan width sidebar */
            overflow-x: auto;
            box-sizing: border-box;
            min-width: 0; /* Tambahkan ini untuk flexbox shrinking */
            margin-left: 20px; /* Tambahkan ini untuk geser ke kanan */
            margin-top: -30px;
        }
        ...
        .row {
            ...
            margin: 0 -15px;
            box-sizing: border-box;
            width: calc(100% + 30px); /* Tambahkan ini */
            margin-right: 0;
        }
        ...
        .table-container {
            width: 100%; /* Ubah dari 115% ke 100% */
            overflow-x: auto;
            margin-top: 20px;
            box-sizing: border-box;
        }
        ...
        margin-top: -10px;
            ...
            .form-header {
                margin-right: 0 !important; /* Reset margin yang terlalu besar */
            }
        ...
        /* Perbaikan untuk navbar agar tetap responsif */
        .navbar .nav-links {
            flex-wrap: wrap;
        }
        ...
        body, .navbar, .container, .sidebar, .main-content, 
        .content, .form-section, .row, .col-md-4, 
        .card, .table-container, table, th, td {
            box-sizing: border-box;
        }

        .form-title {
            margin-left: 20px; /* Geser teks Dashboard ke kanan */
            margin-bottom : 10px;
            margin-top : -10px;
        }
    </style>
...
<body>
    ...
    <div class="container">
        <aside class="sidebar" style="margin-left: 0; padding-left: 15px; padding-right: 20px;">
            <ul>
        ...
        <main class="content" role="main" style="margin-left: 10px; margin-top: -20px;">
                    ...
                    <div class="card" style="border: none; box-shadow: 0 4px 20px rgba(0,0,0,0.08); border-radius: 12px;">
                        ...
                        <div class="card-body" style="padding: 0;">
                            <div class="table-responsive">
                                <table class="table table-hover mb-0" style="border-collapse: separate; border-spacing: 0; min-width: 800px;">
...
function handleNotificationClick(type) {
    ...
    switch(type) {
        case 'order':
            // Notif 'pesanan baru' -> pesanan.php dengan filter 'Menunggu validasi'
            window.location.href = 'pesanan.php?status=approved';
            break;
        case 'pencairan_dana':
            // Notif 'pencairan Dana' -> riwayat_pesanan.php dengan filter 'Selesai - sudah cair'
            window.location.href = 'riwayat_pesanan.php?filter_status=sudah_dicairkan';
            break;
        case 'accepted':
            // Notif 'konfirmasi diterima' -> pesanan.php dengan filter 'menunggu konfirmasi diterima'
            window.location.href = 'pesanan.php?status=accepted';
            break;
        case 'return_confirm':
            // Notif 'konfirmasi pengembalian kostum' -> pesanan.php dengan filter 'menunggu konfirmasi dikembalikan'
            window.location.href = 'pesanan.php?status=pesanan_diterima_penyewa_ready';
            break;
        case 'alert':
            // Notif 'peminjaman terlambat' -> pesanan.php dengan filter 'telat dikembalikan'
